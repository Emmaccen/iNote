...
public class NewMessagesAdapter extends RecyclerView.Adapter<NewMessagesAdapter.viewHolder> {
    Context context;
    ...
    NewMessagesAdapter(ArrayList<UserContract> userMessageList, Context context, ArrayList<ContactListContract> finalContacts) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.new_message_list_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull final viewHolder holder, int position) {
        ...
        if(contactList.isEmpty()){
            contactList.add(holder.getAdapterPosition(), new ContactListContract(users.getPhoneNumber(), users.getPhoneNumber()));
        }
